...
Each timer has a unique ID, duration, and callback function that executes when the timer
expires. The service supports starting, canceling, and resetting timers, with automatic
