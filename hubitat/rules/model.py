...
class BooleanCondition(BaseModel):
    ...
    operator: Literal['and', 'or', 'not'] = Field(description='The boolean operator to combine conditions')
...
class WaitAction(BaseModel):
    ...
    """
    kind: Literal['wait']
    condition: Optional[StateCondition] = Field(default=None, description='The condition to wait for')
    timeout: Optional[int] = Field(default=None, description='The maximum number of seconds to wait for the condition to be true')
